import schedule
from Funciones_Necesarias import fecha, borrarPantalla, clearConsole
import time
...
schedule.every().day.at('00:00:00').do(run_threaded, clearConsole)
#! ---------------------------------------------------------
...
#!--------------------------------DOMINGO-------------------------------
schedule.every().sunday.at("15:55:00").do(run_threaded, Leidsa)
schedule.every().sunday.at("18:05:00").do(run_threaded, Loteria_Nacional)
